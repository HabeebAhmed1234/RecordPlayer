package com.cromiumapps.musicplayer.views;
...
/**
 * Created by Habeeb Ahmed on 1/16/2016.
 */
public class MaskProgressView extends View {
    ...
    public interface OnProgressDraggedListener {
        void onProgressDragged(int position);
        void onProgressDragging(int position);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d("maskprogress", 0 + ", " + (mHeight - mProgressHeight) + ", " + mCurrentProgressPosition + ", " + mHeight);
        canvas.drawRect(
                0,
    ...
    private int calculateCurrentPositionFromCurrentSeconds(int mCurrentSeconds) {
        return mMaxSeconds == 0 ? 0 : mWidth * mCurrentSeconds / mMaxSeconds;
    }
     ...
     * @param mCurrentSeconds
     */
    public void setCurrentSeconds(int mCurrentSeconds) {
     ...
     * @param mMaxSeconds
     */
    public void setMaxSeconds(int mMaxSeconds) {
